...
HD_PWD='C:/rustos/hardware/rv32imacb_zicsr_zifencei_zbc/rv32imacb_zicsr_zifencei_zbc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mbv_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mbv_system_wrapper.tcl -notrace
