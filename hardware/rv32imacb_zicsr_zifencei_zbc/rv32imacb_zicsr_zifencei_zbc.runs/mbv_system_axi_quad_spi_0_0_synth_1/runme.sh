...
HD_PWD='C:/rustos/hardware/rv32imacb_zicsr_zifencei_zbc/rv32imacb_zicsr_zifencei_zbc.runs/mbv_system_axi_quad_spi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbv_system_axi_quad_spi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbv_system_axi_quad_spi_0_0.tcl
