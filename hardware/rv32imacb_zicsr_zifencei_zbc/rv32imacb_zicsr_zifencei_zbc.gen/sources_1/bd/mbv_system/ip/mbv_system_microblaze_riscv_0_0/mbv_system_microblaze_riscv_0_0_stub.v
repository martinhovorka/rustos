...
// Date        : Sat Jan 10 23:02:04 2026
// Host        : STUDIOPC running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub
//               c:/rustos/hardware/rv32imacb_zicsr_zifencei_zbc/rv32imacb_zicsr_zifencei_zbc.gen/sources_1/bd/mbv_system/ip/mbv_system_microblaze_riscv_0_0/mbv_system_microblaze_riscv_0_0_stub.v
// Design      : mbv_system_microblaze_riscv_0_0
...
module mbv_system_microblaze_riscv_0_0(Clk, Reset, Interrupt, Interrupt_Address, 
  ...
  Debug_Rst, Dbg_Disable, Dbg_AWADDR, Dbg_AWVALID, Dbg_AWREADY, Dbg_WDATA, Dbg_WVALID, 
  Dbg_WREADY, Dbg_BRESP, Dbg_BVALID, Dbg_BREADY, Dbg_ARADDR, Dbg_ARVALID, Dbg_ARREADY, Dbg_RDATA, 
  Dbg_RRESP, Dbg_RVALID, Dbg_RREADY)
/* synthesis syn_black_box black_box_pad_pin="Reset,Interrupt,Interrupt_Address[0:31],Interrupt_Ack[0:1],Instr_Addr[0:33],Instr[0:31],IFetch,I_AS,IReady,IWAIT,ICE,IUE,Data_Addr[0:33],Data_Read[0:31],Data_Write[0:31],D_AS,Read_Strobe,Write_Strobe,DReady,DWait,DCE,DUE,Byte_Enable[0:3],M_AXI_DP_AWADDR[33:0],M_AXI_DP_AWPROT[2:0],M_AXI_DP_AWVALID,M_AXI_DP_AWREADY,M_AXI_DP_WDATA[31:0],M_AXI_DP_WSTRB[3:0],M_AXI_DP_WVALID,M_AXI_DP_WREADY,M_AXI_DP_BRESP[1:0],M_AXI_DP_BVALID,M_AXI_DP_BREADY,M_AXI_DP_ARADDR[33:0],M_AXI_DP_ARPROT[2:0],M_AXI_DP_ARVALID,M_AXI_DP_ARREADY,M_AXI_DP_RDATA[31:0],M_AXI_DP_RRESP[1:0],M_AXI_DP_RVALID,M_AXI_DP_RREADY,Dbg_TDI,Dbg_TDO,Dbg_Reg_En[0:7],Dbg_Shift,Dbg_Capture,Dbg_Trig_In[0:7],Dbg_Trig_Ack_In[0:7],Dbg_Trig_Out[0:7],Dbg_Trig_Ack_Out[0:7],Dbg_Trace_Data[0:35],Dbg_Trace_Ready,Dbg_Trace_Valid,Debug_Rst,Dbg_Disable,Dbg_AWADDR[14:2],Dbg_AWVALID,Dbg_AWREADY,Dbg_WDATA[31:0],Dbg_WVALID,Dbg_WREADY,Dbg_BRESP[1:0],Dbg_BVALID,Dbg_BREADY,Dbg_ARADDR[14:2],Dbg_ARVALID,Dbg_ARREADY,Dbg_RDATA[31:0],Dbg_RRESP[1:0],Dbg_RVALID,Dbg_RREADY" */
/* synthesis syn_force_seq_prim="Clk" */
/* synthesis syn_force_seq_prim="Dbg_Clk" */
/* synthesis syn_force_seq_prim="Dbg_Update" */
/* synthesis syn_force_seq_prim="Dbg_Trace_Clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* x_interface_mode = "slave CLK.CLK" *) (* x_interface_parameter = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF M0_AXIS:S0_AXIS:M1_AXIS:S1_AXIS:M2_AXIS:S2_AXIS:M3_AXIS:S3_AXIS:M4_AXIS:S4_AXIS:M5_AXIS:S5_AXIS:M6_AXIS:S6_AXIS:M7_AXIS:S7_AXIS:M8_AXIS:S8_AXIS:M9_AXIS:S9_AXIS:M10_AXIS:S10_AXIS:M11_AXIS:S11_AXIS:M12_AXIS:S12_AXIS:M13_AXIS:S13_AXIS:M14_AXIS:S14_AXIS:M15_AXIS:S15_AXIS:DLMB:ILMB:M_AXI_DP:M_AXI_IP:M_AXI_DC:M_AXI_IC:M_ACE_DC:M_ACE_IC:MON_DLMB:MON_ILMB:MON_AXI_DP:MON_AXI_IP:MON_AXI_DC:MON_AXI_IC:MON_ACE_DC:MON_ACE_IC:S_AXI, ASSOCIATED_RESET Reset, FREQ_HZ 75000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /mbv_clocking_wizard_clk_out1, INSERT_VIP 0" *) input Clk /* synthesis syn_isclock = 1 */;
  ...
  (* x_interface_info = "xilinx.com:interface:lmb:1.0 ILMB ABUS" *) (* x_interface_mode = "master ILMB" *) (* x_interface_parameter = "XIL_INTERFACENAME ILMB, ADDR_WIDTH 34, DATA_WIDTH 32, PROTOCOL STANDARD, HAS_PROT 0, READ_WRITE_MODE READ_ONLY" *) output [0:33]Instr_Addr;
  ...
  (* x_interface_info = "xilinx.com:interface:lmb:1.0 DLMB ABUS" *) (* x_interface_mode = "master DLMB" *) (* x_interface_parameter = "XIL_INTERFACENAME DLMB, ADDR_WIDTH 34, DATA_WIDTH 32, PROTOCOL STANDARD, HAS_PROT 0, READ_WRITE_MODE READ_WRITE" *) output [0:33]Data_Addr;
  ...
  (* x_interface_info = "xilinx.com:interface:aximm:1.0 M_AXI_DP AWADDR" *) (* x_interface_mode = "master M_AXI_DP" *) (* x_interface_parameter = "XIL_INTERFACENAME M_AXI_DP, ID_WIDTH 0, READ_WRITE_MODE READ_WRITE, SUPPORTS_NARROW_BURST 0, HAS_BURST 0, DATA_WIDTH 32, ADDR_WIDTH 34, NUM_READ_OUTSTANDING 1, NUM_WRITE_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, MAX_BURST_LENGTH 1, PROTOCOL AXI4LITE, FREQ_HZ 75000000, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, PHASE 0.0, CLK_DOMAIN /mbv_clocking_wizard_clk_out1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0" *) output [33:0]M_AXI_DP_AWADDR;
  ...
  (* x_interface_info = "xilinx.com:interface:aximm:1.0 M_AXI_DP ARADDR" *) output [33:0]M_AXI_DP_ARADDR;
  ...
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG TRCLK" *) input Dbg_Trace_Clk /* synthesis syn_isclock = 1 */;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG TRDATA" *) output [0:35]Dbg_Trace_Data;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG TRREADY" *) input Dbg_Trace_Ready;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG TRVALID" *) output Dbg_Trace_Valid;
  ...
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG AWADDR" *) input [14:2]Dbg_AWADDR;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG AWVALID" *) input Dbg_AWVALID;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG AWREADY" *) output Dbg_AWREADY;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG WDATA" *) input [31:0]Dbg_WDATA;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG WVALID" *) input Dbg_WVALID;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG WREADY" *) output Dbg_WREADY;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG BRESP" *) output [1:0]Dbg_BRESP;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG BVALID" *) output Dbg_BVALID;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG BREADY" *) input Dbg_BREADY;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG ARADDR" *) input [14:2]Dbg_ARADDR;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG ARVALID" *) input Dbg_ARVALID;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG ARREADY" *) output Dbg_ARREADY;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG RDATA" *) output [31:0]Dbg_RDATA;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG RRESP" *) output [1:0]Dbg_RRESP;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG RVALID" *) output Dbg_RVALID;
  (* x_interface_info = "xilinx.com:interface:mbdebug:3.0 DEBUG RREADY" *) input Dbg_RREADY;
endmodule
