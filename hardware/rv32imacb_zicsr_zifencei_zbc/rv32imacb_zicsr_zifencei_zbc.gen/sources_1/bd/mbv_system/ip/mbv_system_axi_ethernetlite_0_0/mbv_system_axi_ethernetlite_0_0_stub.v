...
// Command     : write_verilog -force -mode synth_stub -rename_top mbv_system_axi_ethernetlite_0_0 -prefix
//               mbv_system_axi_ethernetlite_0_0_ mbv_system_axi_ethernetlite_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "mbv_system_axi_ethernetlite_0_0,axi_ethernetlite,{}" *) (* core_generation_info = "mbv_system_axi_ethernetlite_0_0,axi_ethernetlite,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_ethernetlite,x_ipVersion=3.0,x_ipCoreRevision=36,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,C_FAMILY=artix7,C_SELECT_XPM=1,C_INSTANCE=axi_ethernetlite_inst,C_S_AXI_ACLK_PERIOD_PS=13333,C_S_AXI_ADDR_WIDTH=13,C_S_AXI_DATA_WIDTH=32,C_S_AXI_ID_WIDTH=1,C_S_AXI_PROTOCOL=AXI4LITE,C_INCLUDE_MDIO=1,C_INCLUDE_INTERNAL_LOOPBACK=0,C_INCLUDE_GLOBAL_BUFFERS=1,C_DUPLEX=1,C_TX_PING_PONG=1,C_RX_PING_PONG=1}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_ethernetlite,Vivado 2025.2" *) 
module mbv_system_axi_ethernetlite_0_0(s_axi_aclk, s_axi_aresetn, ip2intc_irpt, 
