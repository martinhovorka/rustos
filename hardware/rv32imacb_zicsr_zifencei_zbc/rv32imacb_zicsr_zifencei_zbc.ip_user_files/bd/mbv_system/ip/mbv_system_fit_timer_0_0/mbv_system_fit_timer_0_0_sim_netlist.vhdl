...
--               x:/hw/rv32imafcb_zicsr_zifencei_zbc/rv32imafcb_zicsr_zifencei_zbc.gen/sources_1/bd/mbv_system/ip/mbv_system_fit_timer_0_0/mbv_system_fit_timer_0_0_sim_netlist.vhdl
...
entity mbv_system_fit_timer_0_0_Divide_part is
  port (
  ...
  attribute ORIG_REF_NAME of mbv_system_fit_timer_0_0_Divide_part : entity is "Divide_part";
end mbv_system_fit_timer_0_0_Divide_part;

architecture STRUCTURE of mbv_system_fit_timer_0_0_Divide_part is
  signal \One_SRL16.SRL16E_I_i_1__3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \One_SRL16.SRL16E_I_i_1__3\ : label is "soft_lutpair0";
...
\One_SRL16.SRL16E_I\: unisim.vcomponents.SRL16E
    generic map(
      ...
      CE => '1',
      CLK => Clk,
      D => \One_SRL16.SRL16E_I_i_1__3_n_0\,
      Q => \^loop_bit\
    );
...
\One_SRL16.SRL16E_I_i_1__3\: unisim.vcomponents.LUT3
    generic map(
      ...
      I1 => \^loop_bit\,
      I2 => Rst,
      O => \One_SRL16.SRL16E_I_i_1__3_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \mbv_system_fit_timer_0_0_Divide_part__parameterized0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \mbv_system_fit_timer_0_0_Divide_part__parameterized0\ : entity is "Divide_part";
end \mbv_system_fit_timer_0_0_Divide_part__parameterized0\;

architecture STRUCTURE of \mbv_system_fit_timer_0_0_Divide_part__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \mbv_system_fit_timer_0_0_Divide_part__parameterized0_0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \mbv_system_fit_timer_0_0_Divide_part__parameterized0_0\ : entity is "Divide_part";
end \mbv_system_fit_timer_0_0_Divide_part__parameterized0_0\;

architecture STRUCTURE of \mbv_system_fit_timer_0_0_Divide_part__parameterized0_0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \mbv_system_fit_timer_0_0_Divide_part__parameterized0_1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \mbv_system_fit_timer_0_0_Divide_part__parameterized0_1\ : entity is "Divide_part";
end \mbv_system_fit_timer_0_0_Divide_part__parameterized0_1\;

architecture STRUCTURE of \mbv_system_fit_timer_0_0_Divide_part__parameterized0_1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \mbv_system_fit_timer_0_0_Divide_part__parameterized1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \mbv_system_fit_timer_0_0_Divide_part__parameterized1\ : entity is "Divide_part";
end \mbv_system_fit_timer_0_0_Divide_part__parameterized1\;

architecture STRUCTURE of \mbv_system_fit_timer_0_0_Divide_part__parameterized1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mbv_system_fit_timer_0_0_FIT_timer is
  port (
    Clk : in STD_LOGIC;
    Rst : in STD_LOGIC;
    Interrupt : out STD_LOGIC
  ...
  attribute C_EXT_RESET_HIGH of mbv_system_fit_timer_0_0_FIT_timer : entity is 1;
  attribute C_FAMILY : string;
  attribute C_FAMILY of mbv_system_fit_timer_0_0_FIT_timer : entity is "artix7";
  attribute C_INACCURACY : integer;
  attribute C_INACCURACY of mbv_system_fit_timer_0_0_FIT_timer : entity is 0;
  attribute C_NO_CLOCKS : integer;
  attribute C_NO_CLOCKS of mbv_system_fit_timer_0_0_FIT_timer : entity is 75000;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mbv_system_fit_timer_0_0_FIT_timer : entity is "FIT_timer";
end mbv_system_fit_timer_0_0_FIT_timer;

architecture STRUCTURE of mbv_system_fit_timer_0_0_FIT_timer is
  signal CE : STD_LOGIC;
...
begin
\Using_SRL16s.SRL16s[1].Divide_I\: entity work.mbv_system_fit_timer_0_0_Divide_part
     port map (
      CE => CE,
      Clk => Clk,
      Rst => Rst,
      ...
      loop_Bit_3 => loop_Bit_6
    );
\Using_SRL16s.SRL16s[2].Divide_I\: entity work.\mbv_system_fit_timer_0_0_Divide_part__parameterized0\
     port map (
      CE => CE_0,
      CE_0 => CE,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[3].Divide_I\: entity work.\mbv_system_fit_timer_0_0_Divide_part__parameterized0_0\
     port map (
      CE => CE_2,
      CE_0 => CE_0,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[4].Divide_I\: entity work.\mbv_system_fit_timer_0_0_Divide_part__parameterized0_1\
     port map (
      CE => CE_4,
      CE_0 => CE_2,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[5].Divide_I\: entity work.\mbv_system_fit_timer_0_0_Divide_part__parameterized1\
     port map (
      CE => CE_4,
      Clk => Clk,
      Interrupt => Interrupt,
...
entity mbv_system_fit_timer_0_0 is
  ...
  attribute NotValidForBitStream of mbv_system_fit_timer_0_0 : entity is true;
  ...
  attribute x_core_info of mbv_system_fit_timer_0_0 : entity is "fit_timer,Vivado 2025.2";
end mbv_system_fit_timer_0_0;

architecture STRUCTURE of mbv_system_fit_timer_0_0 is
  attribute C_EXT_RESET_HIGH : integer;
  ...
  attribute C_NO_CLOCKS : integer;
  attribute C_NO_CLOCKS of U0 : label is 75000;
...
begin
U0: entity work.mbv_system_fit_timer_0_0_FIT_timer
     port map (
      Clk => Clk,
      Interrupt => Interrupt,
      Rst => Rst
